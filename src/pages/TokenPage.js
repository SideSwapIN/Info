      ...
      <BlockedWrapper>
        <BlockedMessageWrapper>
          <AutoColumn gap="1rem" justify="center">
            ...
            <Link external={true} href={'https://scan.zkfair.io/address/' + address}>{`More about ${shortenAddress(
              address
            )}`}</Link>
          </AutoColumn>
        </BlockedMessageWrapper>
          ...
          <DashboardWrapper style={{ marginTop: below1080 ? '0' : '1rem' }}>
            ...
            <RowBetween style={{ marginTop: '3rem' }}>
              ...
              <AutoRow gap="4px" style={{ width: 'fit-content' }}>
                ...
                />
                <QuestionHelper text="USD amounts may be inaccurate in low liquiidty pairs or pairs without USDC or stablecoins." />
              </AutoRow>
            </RowBetween>
            <Panel
              rounded
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://scan.zkfair.io/address/' + address}>
                      View on Explorer ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
